...
l = show_size(SIZE, 0) + show_size(MIN_ITEM, 0) + show_size(MAX_ITEM, 0) + show_size(array, 0) + show_size(val_min, 0) \
    + show_size(val_max, 0) + show_size(i, 0)
print()
print(f'Общее количество памяти занятое под переменные задачи равно {l}')
# Общее количество памяти занятое под переменные задачи равно 856
